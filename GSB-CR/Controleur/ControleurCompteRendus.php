...
class ControleurCompteRendus extends ControleurSecurise {
    ...
    public function ajouter() {
        if ($this->requete->getSession()->existeAttribut('idVisiteur') && $this->requete->existeParametre('idPraticien') && $this->requete->existeParametre('date') && $this->requete->existeParametre('motif') && $this->requete->existeParametre('bilan')) {
