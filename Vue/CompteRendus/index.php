...
<div class="container">
    <h2 class="text-center">Liste de vos compte-rendus de visite</h2>
        ...
        <table class="table table-hover table-condensed">
            ...
            <tr>
                <td class="vert-align"><?= $rapport['dateCR']?></td>
                <td class="vert-align"><?= $rapport['nomPraticien'] . ' ' . $rapport['prenomPraticien']?></td>
                <td class="vert-align"><?= $rapport['villePraticien']?></td>
                <td class="vert-align"><?= $rapport['motifCR']?></td>
                <td>
                    <a href="compterendus/modification/<?= $rapport['idRapport']?>" class="btn btn-info" title="Modifier">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/compterendus/supprimer/<?= $rapport['idRapport']?>" class="btn btn-danger">Supprimer</a>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                    </div><!-- /.modal -->
